...
(defun ome-company-mode-setup ()
  (add-hook 'cider-repl-mode-hook #'company-mode)
  (add-hook 'cider-mode-hook #'company-mode))

(when (executable-find "lein")
  (ome-install 'cider)
  (ome-install 'company-mode)
...
[[http://jayfields.com/expectations/index.html		][Expectations]] is a testing framework for clojure.
Let's add support for [[https://github.com/gar3thjon3s/expectations-mode][expectations-mode]]. The source for this is in the src/ folder.

#+Name: expectations-mode
#+BEGIN_SRC emacs-lisp
(load-file (concat ome-dir "src/expectations-mode.el"))
