...
you should place your code here."
  ...
  (with-eval-after-load 'clojure-mode
    (define-key clojure-mode-map (kbd "M-.") 'spacemacs/jump-to-definition))
  ...
  (with-eval-after-load 'robe-mode
    (define-key robe-mode-map (kbd "M-.") 'dumb-jump-go))
